...
class ExcelExporter:
    ...
    def _create_criteria_sheet(self, results: List[Dict[str, Any]], writer):
        ...
        has_criteria = any(result.get('criteria_breakdown') for result in results)
        ...
        for result in results:
            if result.get('criteria_breakdown'):
                all_criteria.update(result['criteria_breakdown'].keys())
        ...
        for result in results:
            ...
            criteria_scores = result.get('criteria_breakdown', {})
